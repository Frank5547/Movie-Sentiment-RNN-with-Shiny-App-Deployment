...
####################################
setwd("~/Movie Sentiment RNN with Shiny App Deployment")
library(reticulate)

get_prediction_from_LSTM <- function(review, vocabulary_path = "vocabulary_to_int.pkl", best_model_path = "Sentiment_Best_Model.pt"){
